...
company: "The Web Plant",
period: "August 2024 – Apr 2025",
bullets: [
  "Focused on frontend development, building scalable, user-friendly interfaces with modern UI best practices.",
  "Developed responsive and reusable UI components using a mobile-first approach.",
  "Translated Figma designs into pixel-perfect, production-ready frontend interfaces.",
  "Optimized frontend performance and resolved UI/UX issues across devices and browsers.",
]
...
bullets: [
"Built reusable and maintainable frontend components using modern JavaScript practices.",
"Integrated REST APIs into frontend workflows with efficient state handling.",
"Improved UI performance, accessibility, and responsiveness across devices.",
"Worked closely with designers to deliver pixel-perfect user interfaces.",
]
