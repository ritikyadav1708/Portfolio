...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-gradient-to-r from-slate-900 via-indigo-900 to-cyan-900 text-neutral-200">
          ...
          <ul className="flex flex-wrap justify-center md:justify-start gap-6">
            {navLinks.map((link) => (
              <li key={link.id} className="relative group">
                ...
                <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-gradient-to-r from-emerald-400 to-cyan-400 transition-all duration-300 group-hover:w-full" />
              </li>
            ))}
          </ul>
      ...
      {showTopBtn && (
        <button
          ...
          className="
            ...
            p-3 rounded-full bg-cyan-500 text-white
            shadow-lg
